...
The original request specified a set of input documents, some of which are located in `$HOME/.config/zsh/`. Due to workspace restrictions, I was unable to access the following files:

*   `$HOME/.config/zsh/AGENTS.md`
*   `$HOME/.config/zsh/AGENTS.md`
*   `$HOME/.config/zsh/CLAUDE.md`
*   `$HOME/.config/zsh/CONTRIBUTING.md`
*   `$HOME/.config/zsh/CRUSH.md`
*   `$HOME/.config/zsh/WARP.md`
*   `$HOME/.config/zsh/.github/copilot-instructions.md`

**Decision:** Proceed with the refactoring using only the information available within the `ai/` directory. The consolidation will be based on the extensive set of guidelines already analyzed. The final output will be comprehensive, but will not include any information that might have been unique to the inaccessible `zsh` files. A note will be added to the main `AGENTS.md` to reflect this.
