...
Compliant with [/Users/s-a-c/.config/ai/guidelines.md](/Users/s-a-c/.config/ai/guidelines.md) v<computed at runtime by /Users/s-a-c/.config/ai/scripts/policy-check.php>

Purpose
- Define orchestration requirements so every AI task loads and enforces project policies from `/Users/s-a-c/.config/ai/guidelines.md` and `/Users/s-a-c/.config/ai/guidelines/`.
...
1) Policy Context Injection
   - Agents MUST load:
     - `/Users/s-a-c/.config/ai/guidelines.md`
     - All files under `/Users/s-a-c/.config/ai/guidelines/**`
   - Agents MUST compute and expose in their context:
     ...
     - lastModified:
       - master: mtime of `/Users/s-a-c/.config/ai/guidelines.md`
       - modules: max mtime across `/Users/s-a-c/.config/ai/guidelines/**`
...
2) Policy Acknowledgement
   - AI tasks MUST include an acknowledgement header in the artifacts they author:
     - “Compliant with [/Users/s-a-c/.config/ai/guidelines.md](/Users/s-a-c/.config/ai/guidelines.md) v<checksum>”
...
3) Sensitive Actions Rule Citation
   - When performing sensitive actions (security-affecting, code execution, external access, CI configuration), agents MUST cite the exact rules used with clickable references:
     - Example: rule [/Users/s-a-c/.config/ai/guidelines/security.md](/Users/s-a-c/.config/ai/guidelines/security.md:42)
...
5) Enforcement
   - This policy is enforced by:
     - CLI validator: `php /Users/s-a-c/.config/ai/scripts/policy-check.php`
     - Pre-commit hook
